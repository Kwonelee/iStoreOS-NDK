...
echo -e "\\ndefine Device/rk3399_tvi3315a
  ...
  IMAGE/sysupgrade.img.gz := boot-common-legacy | boot-script-legacy | pine64-bin | gzip | append-metadata
...
# 复制defconfig配置文件到uboot-rockchip
...
cp -f $GITHUB_WORKSPACE/configfiles/dts/rk3399/rk3399-opp-cp.dtsi target/linux/rockchip/files/arch/arm64/boot/dts/rockchip/
...
cp -f $GITHUB_WORKSPACE/configfiles/dts/rk3399/rk3399-opp-cp.dtsi package/boot/uboot-rockchip/src/arch/arm/dts/
